...
public class TransformScaling3D implements TransformScaling{

	private float x;
	private float y;
	private float z; 
	
	public TransformScaling3D(float x, float y, float z) {
		this.x = x;
		this.y = y;
		this.z = z;
	}
		
	public TransformScaling3D(Location l) {
		this.x = l.getX();
		this.y = l.getY();
		this.z = l.getZ();
	}
	public TransformScaling3D() {
		this.x = 1;
		this.y = 1;
		this.z = 1;
	}
