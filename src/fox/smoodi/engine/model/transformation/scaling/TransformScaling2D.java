...
public class TransformScaling2D implements TransformScaling {

	private float x;
	private float y;
	
	public TransformScaling2D(float x, float y) {
		this.x = x;
		this.y = y;
	}
		
	public TransformScaling2D(Location l) {
		this.x = l.getX();
		this.y = l.getY();
	}
	public TransformScaling2D() {
		this.x = 1;
		this.y = 1;
	}
