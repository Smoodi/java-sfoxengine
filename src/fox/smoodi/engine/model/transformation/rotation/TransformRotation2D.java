...
public class TransformRotation2D implements TransformRotation{

	private float x;
	private float y;
	
	public TransformRotation2D(float x, float y) {
		this.x = x;
		this.y = y;
	}
		
	public TransformRotation2D(Location l) {
		this.x = l.getX();
		this.y = l.getY();
	}
	public TransformRotation2D() {
		this.x = 1;
		this.y = 1;
	}
